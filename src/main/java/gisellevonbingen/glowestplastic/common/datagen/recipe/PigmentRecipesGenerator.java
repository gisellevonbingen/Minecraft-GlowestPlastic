...
public class PigmentRecipesGenerator extends RecipeProvider
{
	...
	private void addExtratingRecipes(Consumer<FinishedRecipe> consumer)
	{
	...
	private void addPaintingRecipes(Consumer<FinishedRecipe> consumer)
	{
	...
	public static void addExtractionRecipe(Consumer<FinishedRecipe> consumer, EnumColor color, Map<EnumColor, ? extends IItemProvider> map, IPigmentProvider pigment, long rate, String basePath)
	{
	...
	public static void addPaintingRecipe(Consumer<FinishedRecipe> consumer, EnumColor color, Tag<Item> tag, Map<EnumColor, ? extends IItemProvider> map, IPigmentProvider pigment, long rate, String basePath)
	{
